...
import { useBlockUser, useUnblockUser } from '@/feature/dashboard/api/users';
            ...
            <div className="relative">
              <div className="relative px-6 pt-6 pb-4">
                <div className="flex items-start justify-between mb-4">
                  <div className="relative">
                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-white text-xl font-bold shadow-lg transition-transform duration-300 group-hover:scale-110 ${
                      user.isBlocked
                  ...
                  <div className={`relative px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-sm ${
                    user.isBlocked
                ...
                <div className="mb-2">
                  <h3 className="text-lg font-bold text-gray-900 truncate mb-1 group-hover:text-blue-600 transition-colors" title={user.email}>
                    {user.email.split('@')[0]}
                  </h3>
