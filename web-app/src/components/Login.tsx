...
export const Login = () => {
  ...
  const passwordFieldType = isShowPassword ? 'text' : 'password';

  return (
    <div className="flex min-h-screen justify-center items-center">
      <div className="flex flex-col gap-4 items-center">
        <div className="text-3xl text-[#155f82] font-bold pb-2">Sign in</div>

        <form className="flex flex-col gap-2 min-w-[300px]">
          {!isAdminLogin && <TextField label="Email" type="text" leftIcon={emailIcon} />}
          ...
          <div className="flex flex-col gap-1 font-medium mt-2">
            ...
            <button className="text-[#fff] bg-[#155f82] w-full py-2 rounded-lg" type="submit">
